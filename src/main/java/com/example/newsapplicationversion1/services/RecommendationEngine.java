...
public class RecommendationEngine {
    private static final Map<String, List<String>> CATEGORY_MAP = Map.of(
            ...
            "health", List.of("covid","health", "healthcare", "medicine", "mental health", "fitness", "nutrition", "wellness", "diet", "exercise", "disease prevention", "clinical trials", "healthtech", "medtech", "vaccines", "public health", "chronic illness", "hospital care", "biotechnology", "pharmaceuticals", "telemedicine", "treatment", "medical devices", "health insurance", "health data", "gene therapy", "medical research", "alternative medicine", "health apps", "patient care", "health policy", "surgery", "outbreak", "pandemic", "sick", "disease", "cancer", "eczema"),
